...
% PATTERNS_ALM Extracts patterns from a matrix of samples.
%
% STATS = PATTERNS_ALM(SAMPLES, CH, N, K, C) analyzes the input matrix
...
%   k = [2, 3];
%   c = 0;
%   stats = Patterns_ALM(samples, ch, n, k, c);
%
% See also: VEC2MAT
%
