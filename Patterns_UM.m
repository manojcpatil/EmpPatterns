function Stats = Patterns_UM(samples, userpattern, c)
% ----------------------------------------------
% Patterns_UM - Counting Overlapping Patterns
%
% Usage:
%   Stats = Patterns_UM(samples, userpattern, c)
%
% Description:
%   Patterns_UM counts the number of non-overlapping occurrences of a user-defined
